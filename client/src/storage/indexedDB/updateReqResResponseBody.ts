...
const updateReqResResponseBody = async ({
    threadId,
    requestId,
    responseBodyItem,
}: Props): Promise<void> => {
    try {
        ...
        const updatedReqResResponseBody = [
            ...threadBodyArray[reqresIndex].responseBody,
            responseBodyItem,
        ];
        const updatedReqRes = {
            ...threadBodyArray[reqresIndex],
            responseBody: updatedReqResResponseBody,
        };

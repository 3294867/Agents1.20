...
const Name = memo(() => {
    const { threadName, threadIsBookmarked } =
...
const BookmarkButton = memo(() => {
    ...
    const handleClick = async () => {
        await express.updateThreadIsBookmarked({
            threadId,
            isBookmarked: threadIsBookmarked,
        });
        await indexedDB.updateThreadIsBookmarked({
            threadId,
            isBookmarked: threadIsBookmarked,
        });
        dispatchEvent.threadIsBookmarkedUpdated({
            threadId,
            isBookmarked: threadIsBookmarked,
        });
    };

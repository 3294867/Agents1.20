...
const SideNav = memo(() => {
    ...
    const { isVisible, chatWidth } = hooks.features.useHandleSideNav({
    ...
    return (
        isVisible && (
            <motion.div
                ...
                style={{
                    transform: `translateX(calc(50% + ${chatWidth / 2}px + ${constants.sideNavWidth}px + 32px))`,
                    width: constants.sideNavWidth,
                }}
            ...
            >
                {threadBody.map((i) => (
                    <Button
                        ...
                        key={i.requestId}
                        onClick={() =>
                            handleScrollToQuestion({ requestId: i.requestId })
                        }
                    >

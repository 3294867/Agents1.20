    ...
    `,
        ...
        if (addWorkspaceUser.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 503,
                message: "Failed to add workspace user",
            });
        }
    ...
    `);
        if (getRootUserId.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 404,
                message: "Failed to fetch root user id",
            });
        }
    ...
    `,
        ...
        if (getRootAgentIds.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 404,
                message: "Failed to fetch root agents ids",
            });
        }
    ...
    `,
        ...
        if (addGeneralAgent.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 503,
                message: "Failed to add general agent",
            });
        }
    ...
    `,
        ...
        if (addUserAgent.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 503,
                message: "Failed to add user agent",
            });
        }
    ...
    `,
        ...
        if (addWorkspaceAgent.rows.length === 0) {
            ...
            return utils.sendResponse({
                res,
                status: 503,
                message: "Failed to add workspace agent",
            });
        }
